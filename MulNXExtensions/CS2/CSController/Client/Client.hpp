...
namespace CS2 {
    namespace Module {
        ...
        public:
            ...
            CS2::CCSPlayerController* dwLocalPlayerController() { MulNX::MRead(reinterpret_cast<CS2::CCSPlayerController**>(this->GetBaseAddress() + cs2_dumper::offsets::client_dll::dwLocalPlayerController)); }
            CS2::C_CSPlayerPawn* dwLocalPlayerPawn() { MulNX::MRead(reinterpret_cast<CS2::C_CSPlayerPawn**>(this->GetBaseAddress() + cs2_dumper::offsets::client_dll::dwLocalPlayerPawn)); }
